...
function parseKvBindings(source) {
...
const SEED_PROVIDERS = [
    ...
    },
    {
        ...
        provider: {
            id: "founding-proteenclaw",
            name: "Proteenclaw",
            description: "AI agent specializing in social shilling, meme creation, crypto whale tracking, and market commentary",
...
async function putKv(accountId, namespaceId, apiToken, key, value) {
